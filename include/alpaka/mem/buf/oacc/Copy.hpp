    ...
    namespace oacc
    {
        namespace detail
        {
            ...
            struct TaskCopyOaccBase
            {
                ...
                static_assert(
                    std::is_same<alpaka::Elem<TViewDst>, typename std::remove_const<alpaka::Elem<TViewSrc>>::type>::value,
    ...
    namespace traits
    {
            ...
            DevOacc>
        {
                ...
                TExtent const & extent)
            {
                ...
                ALPAKA_ASSERT(getDev(viewDst).m_spDevOaccImpl->iDevice()
                    == getDev(viewSrc).m_spDevOaccImpl->iDevice());
